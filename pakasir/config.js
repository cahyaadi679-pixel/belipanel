module.exports = {
  ...
  IS_SANDBOX: process.env.PAKASIR_SANDBOX === "true",
  ...
  // Gambar (opsional, untuk dokumentasi saja)
  LOGO_MAIN: process.env.LOGO_MAIN || "https://files.catbox.moe/5rm670.bin",
  PLAN_IMAGE_URL: process.env.PLAN_IMAGE_URL || "https://qu.ax/xbwtf"
};
