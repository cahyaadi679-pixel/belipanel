...
const PLANS = [
  ...
  { key: "unlimited", label: "Unlimited", cpu: 0, disk: 0, ram: 0, price: 11000, unlimited: true }
];
...
async function ensureServerForOrder(order) {
  ...
  if (!plan) {
    throw new Error("Plan tidak ditemukan untuk order ini");
  }
